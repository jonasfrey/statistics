...
for n_channel in 0..1{
    a_o.push(
        O_n_min_return_for_u8{
            n_min_nor:v_result[0] as f64 / u8::MAX as f64
...
for n_channel in 0..1{
    a_o.push(
        O_n_max_return_for_u8{
            n_max_nor:v_result[0] as f64 / u8::MAX as f64
...
#[wasm_bindgen]
pub fn f__o_n_min_n_max_for_u8(
    a_n: &[u8]
...
for n_channel in 0..1{
    a_o.push(
        O_n_min_n_max_return_for_u8{
            n_min_nor:v_result[0] as f64 / u8::MAX as f64,
n_max_nor:v_result[1] as f64 / u8::MAX as f64
...
#[wasm_bindgen]
pub fn f__o_n_min_n_mean_for_u8(
    a_n: &[u8]
...
for n_channel in 0..1{
    a_o.push(
        O_n_min_n_mean_return_for_u8{
            n_min_nor:v_result.n_min as f64 / u8::MAX as f64,
...
#[wasm_bindgen]
pub fn f__o_n_max_n_mean_for_u8(
    a_n: &[u8]
...
for n_channel in 0..1{
    a_o.push(
        O_n_max_n_mean_return_for_u8{
            n_max_nor:v_result.n_max as f64 / u8::MAX as f64,
n_sum:v_result.n_mean * n_len
...
#[wasm_bindgen]
pub fn f__o_n_min_n_max_n_mean_for_u8(
    a_n: &[u8]
...
#[wasm_bindgen]
pub fn f__o_n_mean_n_variance_for_u8(
    a_n: &[u8]
...
#[wasm_bindgen]
pub fn f__o_n_min_n_mean_n_variance_for_u8(
    a_n: &[u8]
...
#[wasm_bindgen]
pub fn f__o_n_max_n_mean_n_variance_for_u8(
    a_n: &[u8]
