//This file was automatically generated on Sun Nov 12 2023 01:25:56 GMT+0100 (Central European Standard Time),(1699748756384)
...
for n_channel in 0..1{
    a_o.push(
        O_n_min_return_for_u8{
            n_min_nor:v_acc[0] as f64 / u8::MAX
...
for n_channel in 0..1{
    a_o.push(
        O_n_min_n_mean_return_for_u8{
            n_min_nor:v_acc.n_min as f64 / u8::MAX,
n_sum:v_acc.n_mean * n_len
...
for n_channel in 0..1{
    a_o.push(
        O_n_max_n_mean_return_for_u8{
            n_min_nor:v_acc.n_max as f64 / u8::MAX,
n_sum:v_acc.n_mean * n_len
...
for n_channel in 0..1{
    a_o.push(
        O_n_mean_n_variance_return_for_u8{
            n_sum:v_acc[0] * n_len,
n_variance:(v_acc[0] / n_len) - n_mean.powi(2)
    ...
    #[wasm_bindgen]
    pub struct O_n_mean_n_min_n_variance_return_for_u8 {
        n_sum: f64,
n_min_nor: f64,
n_variance: f64
    }
    ...
    #[wasm_bindgen]
    pub struct O_n_mean_n_min_n_variance_accumulator_for_u8 {
        n_mean: f64,
n_min: u8,
n_variance: f64
    }
...
#[wasm_bindgen]
pub fn f__o_n_mean_n_min_n_variance(
    a_n: &[u8]
) -> O_n_mean_n_min_n_variance_return_for_u8{

    let n_len = a_n.len() as f64;

    
let v_init: O_n_mean_n_min_n_variance_accumulator_for_u8 = O_n_mean_n_min_n_variance_accumulator_for_u8 {
    n_mean:0.0,
n_min:a_n[0],
n_variance:0.0
};
...
for n_channel in 0..1{
    a_o.push(
        O_n_mean_n_min_n_variance_return_for_u8{
            n_sum:v_acc.n_mean * n_len,
n_min_nor:v_acc.n_min as f64 / u8::MAX,
n_variance:(v_acc.n_variance / n_len) - n_mean.powi(2)
    ...
    #[wasm_bindgen]
    pub struct O_n_mean_n_max_n_variance_return_for_u8 {
        n_sum: f64,
n_min_nor: f64,
n_variance: f64
    }
    ...
    #[wasm_bindgen]
    pub struct O_n_mean_n_max_n_variance_accumulator_for_u8 {
        n_mean: f64,
n_max: u8,
n_variance: f64
    }
...
#[wasm_bindgen]
pub fn f__o_n_mean_n_max_n_variance(
    a_n: &[u8]
) -> O_n_mean_n_max_n_variance_return_for_u8{

    let n_len = a_n.len() as f64;

    
let v_init: O_n_mean_n_max_n_variance_accumulator_for_u8 = O_n_mean_n_max_n_variance_accumulator_for_u8 {
    n_mean:0.0,
n_max:a_n[0],
n_variance:0.0
};
...
n_variance:(v_acc.n_variance / n_len) - n_mean.powi(2)
    ...
    #[wasm_bindgen]
    pub struct O_n_mean_n_min_n_max_n_variance_return_for_u8 {
        n_sum: f64,
n_min_nor: f64,
n_min_nor: f64,
n_variance: f64
    ...
    #[wasm_bindgen]
    pub struct O_n_mean_n_min_n_max_n_variance_accumulator_for_u8 {
        n_mean: f64,
n_min: u8,
n_max: u8,
n_variance: f64
...
#[wasm_bindgen]
pub fn f__o_n_mean_n_min_n_max_n_variance(
    a_n: &[u8]
) -> O_n_mean_n_min_n_max_n_variance_return_for_u8{

    let n_len = a_n.len() as f64;

    
let v_init: O_n_mean_n_min_n_max_n_variance_accumulator_for_u8 = O_n_mean_n_min_n_max_n_variance_accumulator_for_u8 {
    n_mean:0.0,
n_min:a_n[0],
n_max:a_n[0],
n_variance:0.0
